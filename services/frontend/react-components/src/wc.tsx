...
import ChatbotWC from "./components/ChatbotWC";
...
const WcChatbot          = reactToWebComponent(ChatbotWC, React, ReactDOM);
...
if (!customElements.get("ub-chatbot")) customElements.define("ub-chatbot", WcChatbot);